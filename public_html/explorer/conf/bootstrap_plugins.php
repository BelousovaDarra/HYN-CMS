...
$PLUGINS = array(
	...
	"AUTH_DRIVER" => array(
		...
		"OPTIONS"       	=> array(
			...
			"LOGIN_URL" 			=> "/login",  // The URL to redirect to if a non-logged user tries to access AjaXplorer
			"LOGOUT_URL" 			=> "/",  // The URL to redirect upon login out
			"SECRET" 				=> "hyn.me-secret",// the secret key that you will pass to the glueCode when communicating with it (see below)
